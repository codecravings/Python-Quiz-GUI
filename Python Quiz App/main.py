...
def loginPage(logdata):
    ...
    login_canvas = Canvas(login, width=720, height=440, bg="mistyrose")
    login_canvas.pack()
...
def signUpPage():
    ...
    sup_canvas = Canvas(sup, width=720, height=440, bg="mistyrose")
    sup_canvas.pack()
...
def menu():
    ...
    menu_canvas = Canvas(menu, width=720, height=440, bg="mistyrose")
    menu_canvas.pack()

    menu_frame = Frame(menu_canvas, bg="white")
    menu_frame.place(relwidth=0.8, relheight=0.8, relx=0.1, rely=0.1)

    wel = Label(menu_canvas, text=' W E L C O M E  T O  Q U I Z  S T A T I O N ', fg="white", bg="red")
...
def easy():
    ...
    easy_canvas = Canvas(e, width=720, height=440, bg="mistyrose")
    easy_canvas.pack()
...
def medium():
    ...
    med_canvas = Canvas(m, width=720, height=440, bg="mistyrose")
    med_canvas.pack()
...
def difficult():
    ...
    hard_canvas = Canvas(h, width=720, height=440, bg="mistyrose")
    hard_canvas.pack()
...
def showMark(mark):
    ...
    show_canvas = Canvas(sh, width=720, height=440, bg="mistyrose")
    show_canvas.pack()
